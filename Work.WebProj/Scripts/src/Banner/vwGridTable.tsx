                            ...
                            return <tr key={i}>
                                <td className="text-xs-center">
                                    <PWButton iconClassName="fa-times" className="btn btn-link btn-lg text-danger"
                                        title={UIText.delete} enable={true} onClick={this.deleteItem.bind(this, item.banner_id) } />
                                </td>
                                <td className="text-xs-center">
                                    <PWButton iconClassName="fa-pencil" className="btn btn-link btn-lg"
                                        title={UIText.modify} enable={true} onClick={this.props.callUpdateItem.bind(this, item.banner_id) } />
                                </td>
                                <td>{item.b_name}</td>
                                <td className="text-xs-center">
                                    <RadioBox
