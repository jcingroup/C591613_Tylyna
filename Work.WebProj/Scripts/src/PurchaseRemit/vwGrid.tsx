            ...
            (
                <div>
                    ...
                    <TagShowAndHide show={this.state.infoShow} TagName={TagName.div}  className="alert alert-warning text-sm">
                        ...
                        <p>本系統僅顯示 「轉帳匯款」或「門市自取付款」 的訂單，且該 「付款狀態」 為 <span className="w3-tag label-danger w3-round">已付款待確認</span> 或 <span className="w3-tag label-success w3-round">確認收款</span> 的資料</p>
                    </TagShowAndHide>
