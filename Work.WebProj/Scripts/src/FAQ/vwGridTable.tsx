...
export class GridTable extends React.Component<any, any>{
    ...
    render() {
        ...
        let pp = this.props;
        let grid: Array<server.FAQ> = pp.grid;
        out_html =
            (
                            ...
                            return <tr key={i}>
                                <td className="text-xs-center">
                                    <PWButton iconClassName="fa-times" className="btn btn-link btn-lg text-danger"
                                        title={UIText.delete} enable={true} onClick={this.deleteItem.bind(this, item.faq_id) } />
                                </td>
                                <td className="text-xs-center">
                                    <PWButton iconClassName="fa-pencil" className="btn btn-link btn-lg"
                                        title={UIText.modify} enable={true} onClick={this.props.callUpdateItem.bind(this, item.faq_id) } />
                                </td>
                                <td>{item.q_title}</td>
                                <td className="text-xs-center">
                                    <RadioBox
