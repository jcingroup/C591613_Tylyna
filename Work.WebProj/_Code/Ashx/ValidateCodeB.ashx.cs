...
{
    public class ValidateCodeB : IHttpHandler, IRequiresSessionState
    {
        ...
        private void CreateCheckCodeImage(string checkCode, HttpContext context)
        {
            ...
            System.Drawing.Bitmap image = new System.Drawing.Bitmap(302, 65);
            ...
            try
            {
                ...
                Font font = new System.Drawing.Font("Arial", 48, (FontStyle.Regular));
